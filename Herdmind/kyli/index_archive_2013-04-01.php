...
<HTML>
<HEAD>
<a href="./">directory of ./</a><br/> <!-- What the heck is this? -->
<a href="../">directory of ../</a><br/>
<!-- BEGIN Metadata -->
...
<SECTION>
	<?PHP
	startPortalList();
		buildPortalItem("Doctor Who", "http://tardis.herdmind.net/",
						"http://herdmind.net/CSS/herdmind/SubsiteButtons/button_tardis.png");
		buildPortalItem("My Little Pony: Friendship is Magic", /*"http://pony.herdmind.net/"*/"pony",
...
<SECTION>
	<H2>About</H2>
	<P>Herdmind is an ongoing project for communities to propegate and vote upon their ideas of how different fictions work.</P>
</SECTION>
